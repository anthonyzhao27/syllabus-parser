        ...
        >
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-warm-200 bg-white py-3 text-sm font-semibold text-warm-700 transition-colors hover:border-mint-300 hover:bg-mint-50 disabled:cursor-not-allowed disabled:opacity-60"
            >
              <svg
                width="18"
                height="18"
